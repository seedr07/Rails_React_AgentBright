class Invoice
  ...
  delegate :name, :billing_organization, :billing_address, :billing_address_2, :billing_city, :billing_state, :billing_zip_code, :billing_country, :email,
    to: :user, prefix: true
  ...
  def to_partial_path
    "subscriber/invoice/#{self.class.name.underscore}"
  end
